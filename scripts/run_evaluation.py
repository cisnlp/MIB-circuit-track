...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--circuit_files", type=str, nargs="+", default=None)
    ...
    parser.add_argument("--optimal_ablation_path", type=str)
...
def main() -> None:
    ...
    """
    args = parse_args()
    #check if method name contains information flow routes
    # (could be an ensembling method involving it).
    #the set of strings is in case someone implements another method
    # that also requires the greedy algorithm.
    apply_greedy = any(name in args.method for name in ["information-flow-routes"])
